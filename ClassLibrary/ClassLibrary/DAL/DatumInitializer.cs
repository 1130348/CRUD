...
namespace ClassLibrary.DAL
{
    public class DatumInitializer : System.Data.Entity.DropCreateDatabaseIfModelChanges<DatumContext>
    {
        ...
        protected override void Seed(DatumContext context)
        {
            ...
            //{
            //    new POI { PoiID=1,Nome="McDonald's",Descricao="Restaurante",LocalID=1 },
            //    new POI { PoiID=2,Nome="A Abundância",Descricao="Monumento",LocalID=1 },
            //    new POI { PoiID=3,Nome="A Nacional",Descricao="Monumento",LocalID=1 }
            //};
